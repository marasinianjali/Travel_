...
urlpatterns = [
    ...
    path('report/<int:pk>/update/', views.update_expense_report, name='update_expense_report'),
    path('report/<int:pk>/delete/', views.delete_expense_report, name='delete_expense_report'),
    path('report/<int:pk>/', views.view_expense_report, name='view_expense_report'),
]